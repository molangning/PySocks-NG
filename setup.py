...
setup(
    name="PySocks",
    version=VERSION,
    description="Python SOCKS client module, New generation. See https://github.com/molangning/PySocks-NG for more information.",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/molangning/PySocks-NG",
